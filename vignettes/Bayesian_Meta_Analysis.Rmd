...
The hierarchical model utilizes the posterior estimates for the hyper parameters $\mu$ and $\tau^2$ rather than estimating them empirically. They are updated in every step of the algorithm as well.
