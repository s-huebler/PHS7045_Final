...
marginalLikelihood(as.matrix(data_ex[,2:5]), 0.2, 0.1, 1000000, 0, 100) 
```
```{r}
...
```{r}
marginalLikelihood(as.matrix(data_ex[,2:5]), 0.2, 0.1, 1000000, 0, 100)
marginalLikelihood(as.matrix(data_ex[,2:5]), 0.1443, 0.086, 1000000, 0, 100)
```
```{r}
mhGibbs(data_ex, hyperparameters_ex, 0.99, sim = 12, burn = 2)
```
```{r}
...
test |>
  ...
  # #           labeller = as_labeller(posterior_labels))+
  # ggplot2::theme_minimal()+
  # ggplot2::xlab("Estimate")+
  # ggplot2::ylab("Frequency")+
  # ggplot2::ggtitle("Study Specific Log Odds Ratio Posterior Distributions")
```
